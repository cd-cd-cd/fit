...
def run(model_path):
    ...
    if args.dataset.lower() == 'fashioniq':
        ...
        # 打开文件，并使用写入模式
        with open('/amax/home/chendian/FTI2/save_valid/metrics_fiq.csv', 'a', newline='') as csvfile:
...
if __name__ == '__main__':
    for i in range(0, 20):
        run(f'/amax/home/chendian/FTI2/save_model/epoch_120_prompt/model_{i}.pth')
