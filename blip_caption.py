...
def main():
    ...
    # test dataset path
    parser.add_argument('--model_url', type=str, default="/amax/home/chendian/huggingface/model_base_caption_capfilt_large.pth") #
    ...
    parser.add_argument('--img_path', type=str, default="/amax/home/chendian/dataset/ImageNet12/")
